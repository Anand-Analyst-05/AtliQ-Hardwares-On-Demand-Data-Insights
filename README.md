# AtliQ-Hardwares-On-Demand-Data-Insights
Hello, Welcome to AtliQ Hardwares On Demand Data Insights Project

## This Project focuses on 3 departments

- Finance Analysis
- Top Customer, Product and Market 
- Supply Chain Analytics

## 

This project leverages SQL to track finance, Top Customer, Product, Market and supply chain performance for AtliQ India. It helps analyze sales trends, check forecast accuracy, and spot key patterns in customer purchases and product sales.
...
🔗 **Let's connect on [LinkedIn](# SQL Project: Finance and Supply Chain Analytics
